...
export default function CreateAutomatedOrder() {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            Threshold: parseInt(threshold.trim(), 10), // <-- must be "Threshold"
        ...
        try {
            ...
            if (response.ok) {
                ...
                setErrorMessage(errorText || "Failed to create automated order.");
                setSuccessMessage("");
            }
        } catch (err) {
            console.error("Error creating automated order:", err);
        ...
        <div className="add-product-page">
            ...
            <FormWrapper title="Enter Automated Order Details:">
                <form className="add-product-form" onSubmit={handleSubmit}>
                    ...
                    <AddButton text="Create New Automated Order" type="submit" />
                </form>
            </FormWrapper>
        </div>
    );
